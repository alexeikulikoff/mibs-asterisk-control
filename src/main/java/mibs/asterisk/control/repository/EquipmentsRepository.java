...
public interface EquipmentsRepository extends CrudRepository<EquipmentsEntity, Long>{
	...
	@Modifying 
	@Query("UPDATE EquipmentsEntity u SET u.phone= :phone, u.password=:password, u.office=:office, u.p=:p, u.ipaddress=:ipaddress, u.netmask=:netmask, u.gateway=:gateway, u.person=:person where u.id=:id")
	void updateEquipments(@Param("phone") String phone, @Param("password") String password, @Param("office") String office,
			...
			@Param("person") String person ,@Param("id") Long id);
